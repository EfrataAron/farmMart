...
import { FaTwitter as Twitter, FaFacebook as Facebook, FaInstagram as Instagram, FaLinkedin as Linkedin } from 'react-icons/fa';
      ...
      <div className="px-4 sm:px-6 lg:px-10 py-8 sm:py-12 lg:py-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 text-center sm:text-left">
            <Link href="/" className="footer-brand flex items-center justify-center sm:justify-start space-x-3 mb-4 sm:mb-6">
              <div className="brand-icon w-10 h-10 sm:w-12 sm:h-12 rounded-lg flex items-center justify-center">
                <span className="text-white font-bold text-lg sm:text-xl">{/* Logo */}
                            <div className="flex items-center space-x-3 min-w-fit flex-shrink-0">
                              <div className="bg-green-600 p-2 rounded-full">
                                <BiLeaf className="w-6 h-6 text-white" />
                              </div></div></span>
              </div>
              <span className="text-xl sm:text-2xl lg:text-3xl font-bold">AgriLink</span>
            </Link>
            <div className="space-y-1 sm:space-y-2 text-gray-400 text-sm sm:text-base max-w-md mx-auto sm:mx-0">
              <p className="text-center sm:text-left">Agricultural Products Rural</p>
              <p className="text-center sm:text-left">Entrepreneurship/Management Systems</p>
          ...
          {footerSections.map((section, index) => (
            <div key={index} className="footer-section text-center sm:text-left">
        ...
        <div className="footer-bottom border-t border-gray-800 mt-4 sm:mt-8 pt-6 sm:pt-8">
          <div className="flex flex-col items-center sm:flex-row sm:justify-between space-y-4 sm:space-y-0">
            ...
            <div className="footer-links flex flex-wrap justify-center space-x-4 sm:space-x-6">
              <Link href="/privacy-policy" className="text-gray-400 hover:text-white text-xs sm:text-sm transition-colors duration-200">
                Privacy Policy
              </Link>
              <Link href="/terms-conditions" className="text-gray-400 hover:text-white text-xs sm:text-sm transition-colors duration-200">
