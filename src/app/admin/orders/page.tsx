...
export default function OrdersPage() {
  ...
  const stats = useMemo(() => {
    ...
    return { total, pending, confirmed, inTransit, delivered, cancelled, totalRevenue }
  }, [orders])
  ...
  function handleSaveChanges(event: React.MouseEvent<HTMLButtonElement, MouseEvent>): void {
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500">{order.farmer.email}</div>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${getPaymentColor(selectedOrder.paymentStatus)}`}>
            ...
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-12 h-12 rounded-full overflow-hidden bg-gray-200 relative">
                      <Image
                        src={selectedOrder.buyer.avatar || '/default-avatar.jpg'}
                    ...
                    <div>
                      ...
                      <div className="text-sm text-gray-500">{selectedOrder.buyer.email}</div>
                    </div>
                  </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-12 h-12 rounded-full overflow-hidden bg-gray-200 relative">
                      <Image
                        src={selectedOrder.farmer.avatar || '/default-avatar.jpg'}
                    ...
                    <div>
                      <div className="font-medium text-gray-900">{selectedOrder.farmer.name}</div>
                      <div className="text-sm text-gray-500">{selectedOrder.farmer.email}</div>
                    </div>
                  </div>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <FiPhone className="w-4 h-4 text-gray-400" />
                      <span className="text-sm text-gray-600">{selectedOrder.farmer.phone}</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg mb-6">
                ...
                <div className="mt-4 pt-4 border-t border-gray-200 flex justify-between items-center">
                  ...
                  <span className="text-xl font-bold text-gray-900">{formatCurrency(selectedOrder.totalAmount)}</span>
                </div>
              </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="font-medium text-gray-900">{formatDateTime(selectedOrder.orderDate)}</div>
                    </div>
                    {selectedOrder.deliveryDate && (
                      <div>
                        <div className="text-sm text-gray-600">Delivery Date</div>
                        <div className="font-medium text-gray-900">{formatDateTime(selectedOrder.deliveryDate)}</div>
                      </div>
                    )}
                  </div>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="font-medium text-gray-900">{selectedOrder.deliveryAddress}</div>
                    </div>
                    {selectedOrder.notes && (
                      <div>
                        <div className="text-sm text-gray-600">Notes</div>
                        <div className="font-medium text-gray-900">{selectedOrder.notes}</div>
                      </div>
                    )}
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEditForm({...editForm, paymentStatus: e.target.value as Order['paymentStatus']})}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent appearance-none bg-white"
                  >
                    <option value="pending">Pending</option>
                    <option value="paid">Paid</option>
                ...
                <div>
                  ...
                  <input
                    type="datetime-local"
                    value={editForm.deliveryDate ? new Date(editForm.deliveryDate).toISOString().slice(0, 16) : ''}
                    onChange={(e) => setEditForm({...editForm, deliveryDate: e.target.value ? new Date(e.target.value).toISOString() : undefined})}
