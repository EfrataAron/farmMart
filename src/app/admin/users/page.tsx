...
const usersData: User[] = [
  {
    ...
    totalEarnings: 12500,
    rating: 4.8,
    bio: 'Organic farmer with 15+ years experience in sustainable agriculture.',
    address: '1234 Farm Road, Fresno, CA 93722',
    businessName: 'Smith Organic Farm',
    businessType: 'Organic Vegetables',
    experience: '15 years',
    specialization: ['Organic Tomatoes', 'Leafy Greens', 'Herbs']
  },
  {
    id: 'USR002',
    name: 'Sarah Johnson',
    ...
    totalEarnings: 25000,
    rating: 4.9,
    bio: 'Restaurant chain buyer focused on fresh, local produce.',
    address: '567 Business Ave, New York, NY 10001',
    businessName: 'Fresh Eats Restaurant Group',
    businessType: 'Restaurant Chain',
    experience: '8 years',
    specialization: ['Fresh Produce', 'Seasonal Vegetables', 'Organic Fruits']
  },
  {
    id: 'USR003',
    name: 'Michael Chen',
    ...
    totalEarnings: 18000,
    rating: 4.7,
    bio: 'Reliable transport services for agricultural products.',
    address: '890 Transport Lane, Houston, TX 77001',
    businessName: 'Chen Logistics',
    businessType: 'Cold Chain Transport',
    experience: '10 years',
    specialization: ['Refrigerated Transport', 'Long Distance', 'Fresh Produce']
  },
  {
    id: 'USR004',
    ...
    totalEarnings: 0,
    rating: 0,
    bio: 'New farmer specializing in tropical fruits.',
    address: '123 Tropical Way, Miami, FL 33101',
    businessName: 'Rodriguez Tropical Farm',
    businessType: 'Tropical Fruits',
    experience: '3 years',
    specialization: ['Mangoes', 'Avocados', 'Citrus Fruits']
  },
  {
    id: 'USR005',
    name: 'David Thompson',
    ...
    totalEarnings: 8500,
    rating: 3.2,
    bio: 'Local grocery store buyer.',
    address: '456 Market St, Portland, OR 97201',
    businessName: 'Thompson Grocery',
    businessType: 'Retail Store',
    experience: '12 years',
    specialization: ['Local Produce', 'Seasonal Items', 'Bulk Orders']
  }
]
...
export default function UsersPage() {
  ...
  const getRoleIcon = (role: string) => {
    switch (role) {
      case 'farmer': return <FiPackage className="w-4 h-4" />
      case 'buyer': return <FiDollarSign className="w-4 h-4" />
      case 'transporter': return <FiTruck className="w-4 h-4" />
  ...
  const handleAddUser = () => {
    if (addForm.name && addForm.email && addForm.phone) {
      const newUser: User = {
        ...
        status: addForm.status as User['status'],
        joinedDate: new Date().toISOString(),
        lastActive: new Date().toISOString(),
        verified: addForm.verified || false,
        documentsSubmitted: addForm.documentsSubmitted || false,
        totalOrders: 0,
        totalEarnings: 0,
        rating: 0,
        bio: addForm.bio,
              ...
              <div className="bg-white rounded-xl max-w-md w-full shadow-2xl border border-gray-200">
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-medium text-gray-900">Delete Selected Users</h3>
                      <p className="text-sm text-gray-600">
                        Are you sure you want to delete <span className="font-medium">{selectedUsers.length}</span> selected users? This action cannot be undone.
                      </p>
                    </div>
                  </div>
                ...
                <tr key={user.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="w-10 h-10 rounded-full overflow-hidden bg-gray-200 mr-4 relative">
                        <Image
                      ...
                      <div>
                        <div className="text-sm font-medium text-gray-900 flex items-center gap-2">
                          {user.name}
                          {user.verified && (
                            <FiCheck className="w-4 h-4 text-green-500" title="Verified" />
                          )}
                        </div>
              ...
              <form onSubmit={(e) => { e.preventDefault(); handleSaveEdit(); }} className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    required
                    value={editForm.role}
                    onChange={(e) => setEditForm(prev => prev ? ({ ...prev, role: e.target.value as User['role'] }) : null)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
                  >
                    <option value="farmer">Farmer</option>
                    <option value="buyer">Buyer</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEditForm(prev => prev ? ({ ...prev, status: e.target.value as User['status'] }) : null)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
                  >
                    <option value="active">Active</option>
                    <option value="inactive">Inactive</option>
                ...
                <div className="flex items-center">
                  <input
                    ...
                    onChange={(e) => setEditForm(prev => prev ? ({ ...prev, verified: e.target.checked }) : null)}
                    className="rounded border-gray-300 text-green-600 focus:ring-green-500"
                  />
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-gray-50 p-3 rounded-lg">
                    ...
                    <div className="mt-1">
                      <span className={`inline-flex items-center gap-1 px-2 py-1 text-xs font-medium rounded-full ${getRoleColor(selectedUser.role)}`}>
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg">
                    ...
                    <p className="mt-1 text-sm text-gray-900">{formatDate(selectedUser.joinedDate)}</p>
                  </div>
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg">
                    ...
                    <p className="mt-1 text-sm text-gray-900">{formatCurrency(selectedUser.totalEarnings)}</p>
                  </div>
                  
                  <div className="bg-gray-50 p-3 rounded-lg">
                    <label className="block text-sm font-medium text-gray-700">Last Active</label>
                    <p className="mt-1 text-sm text-gray-900">{formatDate(selectedUser.lastActive)}</p>
                  </div>
                  ...
                  <div className="bg-gray-50 p-3 rounded-lg">
                    ...
                    <p className="mt-1 text-sm text-gray-900">
                      {selectedUser.rating > 0 ? `${selectedUser.rating}/5.0` : 'No rating yet'}
                    </p>
                  </div>
                </div>
                
                {/* Business Information */}
                {selectedUser.businessName && selectedUser.role !== 'buyer' && (
                  <div className="bg-blue-50 p-4 rounded-lg">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-gray-900">{selectedUser.experience}</p>
                      </div>
                      <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg shadow-sm">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-900">Placed order #12345</p>
            ...
            <div className="p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Are you sure you want to suspend <span className="font-medium">{userToSuspend.name}</span>? 
