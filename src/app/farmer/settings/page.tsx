...
export default function SettingsPage() {
  ...
  const handleToggle = <
    ...
    F extends keyof PlatformSettings[S]
  >(
    section: S,
    field: F
  ) => {
                        ...
                        <div className="flex gap-3">
                          <button
                            ...
                            className={`flex items-center gap-2 px-4 py-2 rounded-lg border-2 transition-colors focus:outline-none ${
                              theme === "light"
                                ? "border-orange-500 bg-orange-50 dark:bg-[#23272F] text-orange-700 dark:text-orange-400 ring-2 ring-orange-400"
                  ...
                  <div className="bg-gray-50 rounded-lg p-4 mb-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <ToggleSwitch
                        ...
                        onToggle={() =>
                          handleToggle("appearance", "sidebarCollapsed")
                        }
                      ...
                      <ToggleSwitch
                        ...
                        onToggle={() =>
                          handleToggle("appearance", "animationsEnabled")
                        }
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className="space-y-3">
                        ...
                        <ToggleSwitch
                          ...
                          onToggle={() =>
                            handleToggle("notifications", "systemAlerts")
                          }
                          label="System Alerts"
                        />
                      </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className="space-y-3">
                        ...
                        <ToggleSwitch
                          ...
                          onToggle={() =>
                            handleToggle("security", "enableFirewall")
                          }
                        ...
                        <ToggleSwitch
                          ...
                          onToggle={() =>
                            handleToggle("security", "enableRateLimiting")
                          }
                          label="Rate Limiting"
                        />
                        <ToggleSwitch
                          ...
                          onToggle={() =>
                            handleToggle("security", "dataEncryption")
                          }
                        ...
                        <ToggleSwitch
                          ...
                          onToggle={() =>
                            handleToggle("security", "auditLogging")
                          }
                          label="Audit Logging"
                        />
                      </div>
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className="space-y-3">
                        <ToggleSwitch
                          ...
                          onToggle={() =>
                            handleToggle("system", "maintenanceMode")
                          }
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className="space-y-3">
                        <ToggleSwitch
                          ...
                          onToggle={() =>
                            handleToggle("system", "cacheEnabled")
                          }
                        ...
                        <ToggleSwitch
                          ...
                          onToggle={() =>
                            handleToggle("system", "compressionEnabled")
                          }
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg">
                      ...
                      <div className="space-y-3">
                        <ToggleSwitch
                          ...
                          onToggle={() =>
                            handleToggle("system", "analyticsEnabled")
                          }
                        ...
                        <ToggleSwitch
                          ...
                          onToggle={() =>
                            handleToggle("system", "errorReporting")
                          }
                        ...
                        <ToggleSwitch
                          ...
                          onToggle={() =>
                            handleToggle("system", "performanceMonitoring")
                          }
