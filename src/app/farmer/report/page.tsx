...
const categoryAnalytics: CategoryAnalytics[] = [
  {
    category: "Vegetables",
    totalProducts: 1456,
    approvedProducts: 1367,
    pendingProducts: 67,
    revenue: 178900,
    orders: 2456,
    avgPrice: 4.5,
    topFarmer: "Green Valley Farm",
    growth: 15.2,
  },
  {
    category: "Fruits",
    totalProducts: 892,
    approvedProducts: 834,
    pendingProducts: 45,
    revenue: 145600,
    orders: 1789,
    avgPrice: 6.8,
    topFarmer: "Sunshine Orchards",
    growth: 12.8,
  },
  {
    category: "Grains",
    totalProducts: 654,
    approvedProducts: 612,
    pendingProducts: 34,
    revenue: 89200,
    orders: 1234,
    avgPrice: 3.2,
    topFarmer: "Heritage Grains Co.",
    growth: 8.9,
  },
  {
    category: "Dairy & Eggs",
    totalProducts: 454,
    approvedProducts: 420,
    pendingProducts: 32,
    revenue: 67800,
    orders: 987,
    avgPrice: 5.9,
    topFarmer: "Fresh Farm Dairy",
    growth: 18.7,
  },
];
...
const topFarmers: FarmerPerformance[] = [
  ...
  },
  {
    ...
    email: "info@sunshineorchards.com",
    joinDate: "2024-02-20",
    totalProducts: 38,
    approvedProducts: 36,
    pendingProducts: 1,
  ...
  },
  {
    ...
    email: "sales@heritagegrains.com",
    joinDate: "2023-11-10",
    totalProducts: 32,
    approvedProducts: 31,
    pendingProducts: 1,
  ...
  },
  {
    ...
    email: "orders@freshfarmdairy.com",
    joinDate: "2024-03-15",
    totalProducts: 28,
    approvedProducts: 26,
    pendingProducts: 2,
...
const topBuyers: BuyerAnalytics[] = [
  ...
  },
  {
    ...
    email: "chef@localrestaurants.com",
    joinDate: "2024-03-20",
    totalOrders: 98,
    totalSpent: 28700,
    avgOrderValue: 292.86,
    favoriteCategory: "Vegetables",
  ...
  {
    id: "B004",
    name: "Healthy Eats Delivery",
    email: "orders@healthyeats.com",
    joinDate: "2024-04-12",
    totalOrders: 89,
    totalSpent: 24500,
    avgOrderValue: 275.28,
    favoriteCategory: "Dairy & Eggs",
    lastOrder: "2025-01-07",
    status: "active",
  },
  {
    id: "B005",
    name: "School District #45",
    email: "nutrition@schooldistrict45.edu",
    joinDate: "2024-05-30",
    totalOrders: 76,
    totalSpent: 19800,
    avgOrderValue: 260.53,
  ...
  return (
    <div className="flex bg-gray-50 w-full max-w-full">
      ...
      <div className="flex-1 flex flex-col lg:ml-0 w-full max-w-full">
        ...
        <main className="flex-1 p-3 sm:p-4 md:p-6 lg:p-8 w-full max-w-full">
          {/* Header */}
