...
export default function ProjectDetailPage({ 
  ...
  const getStatusIcon = (status: ProjectStatus) => {
    switch (status) {
      ...
      case 'ongoing': return <FiPlay className="w-4 h-4" />;
      case 'planning': return <FiClock className="w-4 h-4" />;
      case 'on-hold': return <FiPause className="w-4 h-4" />;
      default: return null;
    }
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {project.technologies && project.technologies.length > 0 && (
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  <h2 className="text-xl font-semibold text-gray-900 mb-4">Technologies & Methods</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Interested in this project? Contact our team for more information.
                </p>
                <div className="space-y-3">
                  <a 
                    href="mailto:projects@agrilink.com"
                    className="flex items-center gap-3 text-green-600 hover:text-green-700 transition-colors"
                  >
                    <FiMail className="w-4 h-4" />
                    <span className="text-sm">projects@agrilink.com</span>
                  </a>
                  <a 
                    href="tel:+1234567890"
                    className="flex items-center gap-3 text-green-600 hover:text-green-700 transition-colors"
