...
export default function IrrigationSetupPage() {
  ...
  return (
    <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-10 xl:px-16">
      <ServiceFilterBar />
      <h1 className="text-4xl font-bold text-green-700 mb-4">Irrigation Setup</h1>
      <p className="text-gray-700 mb-6">
        Ensure your crops get the water they need, when they need it. AgriLink’s irrigation setup service provides expert design, installation, and support for efficient, sustainable watering systems.
      </p>
      <div className="flex flex-col lg:flex-row lg:items-start lg:gap-12 mb-0 pb-0">
        ...
        <div className="flex-1 lg:mb-0 flex flex-col items-center justify-center">
          ...
          <section className="mt-4 w-full">
            <h2 className="text-2xl font-semibold text-green-600 mb-2">Why Use Our Irrigation Setup Service?</h2>
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-700 mb-4">
            Fill out the form below and our irrigation experts will contact you to discuss your needs.
          </p>
          {!submitted ? (
