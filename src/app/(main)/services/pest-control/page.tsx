...
export default function PestControlPage() {
  ...
  return (
    <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-10 xl:px-16">
      <ServiceFilterBar />
      <h1 className="text-4xl font-bold text-orange-700 mb-4">Pest Control</h1>
      <p className="text-gray-700 mb-6">
        Protect your crops and maximize your yields with farmMart’s expert pest
        control services. We offer integrated pest management solutions that are
        safe, effective, and tailored to your farm.
      </p>
      <div className="flex flex-col lg:flex-row lg:items-start lg:gap-12 mb-0 pb-0">
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-700 mb-4">
            Fill out the form below and our pest control experts will contact
