  ...
  return (
    <div className="mb-10">
      <h2 className="text-4xl font-bold mb-2 text-center">
        <span className="text-black">AgriLink</span> <span className="text-green-700">Services</span>
      </h2>
      <p className="text-gray-700 text-center max-w-2xl mx-auto mb-4">
        AgriLink empowers farmers with expert services tailored to every stage of the agricultural journey.
      </p>
